...
//     `http://localhost:5000/articles?limit=10&offset=${pageParam}`
//   );
  ...
  return (
    <div>
      {/* <form className="mt-20 mb-10" onSubmit={handelSearch}>
        <input className="bg-blue-gray-100 py-4" type="text" name="search" id="" />
        <input className="pl-5 py-4 px-5 rounded bg-black text-white ml-10" type="submit" value="Search" />
      </form> */}
      <InfiniteScroll
        dataLength={articles ? articles.length : 0}
        next={() => fetchNextPage()}
