...
const News = () => {
  ...
  const filteredArticles = data?.pages
    ...
    ?.filter((article) => {
      const isTagMatch = !tags || article.publisherName === tags;
      return isTagMatch && article.status === "Approve";
    });
      ...
      <div className="flex justify-between mx-20 mb-10">
        <div className="">
          ...
          >
            ...
            <option value="Najmul Hasan">Najmul Hasan</option>
            <option value="Anolipi Desk">Anolipi Desk</option>
          ...
          {filteredArticles?.map((article) => (
            ...
            >
              ...
              <div className="mx-4 mt-3 mb-4">
                {article.isPremium === "Yes" && !isPremium ? (
                  <Link>
                    <button
                      className="select-none cursor-pointer w-full rounded-lg bg-[#334074] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                      type="button"
